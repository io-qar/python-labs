...
def get_empty_neighbor(index):
	'''Getting index of empty neighbor'''
...
def draw_board():
	...
	# убираем всё, что нарисовано на холсте
	c.delete('all')
	# Наша задача сгруппировать пятнашки из списка в квадрат со сторонами BOARD_SIZE x BOARD_SIZE
